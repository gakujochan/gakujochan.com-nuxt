<template>
  <div>
    ...
    <br />
    <details open>
      <summary>Mozilla Firefoxを使っているユーザーさんへ</summary>
    ...
    <br />
    <h2>作ってくれたユーザーさんのTwitter</h2>
    <p>
      <a
        class="twitter-timeline"
        data-height="500"
        href="https://twitter.com/koji_genba?ref_src=twsrc%5Etfw"
        >Tweets by koji_genba</a
      >
      <script
        async
